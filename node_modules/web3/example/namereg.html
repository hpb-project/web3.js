...
<body>
    <i>This example shows only part of namereg functionalities. Namereg contract is available <a href="https://github.com/High Performance Blockchain/dapp-bin/blob/master/GlobalRegistrar/contract.sol">here</a>
    </i>
    <h1>Namereg</h1>
