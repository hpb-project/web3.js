...
function execute(){
    ...
    console.log("**********************************************************************");
    console.log("1. Deploy the following contract in your High Performance Blockchain environment");
...
// Value 1- Please provide the High Performance Blockchain account address which you want to use to perform the operation
